...
CREATE TABLE `t_attendance` (
  ...
  `key_day` varchar(2) NOT NULL,
  `s_time` time DEFAULT NULL,
  `e_time` time DEFAULT NULL,
  `br_time` double DEFAULT NULL,
  ...
  `del_cd` int NOT NULL,
  PRIMARY KEY (`key_year_month`,`key_day`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='TBL007 근태 테이블';
...
-- Dump completed on 2023-01-16 14:15:44
